      ...
      <div className="space-y-2 pt-6 pb-4 md:space-y-5">
        ...
        <p className="space-y-4 text-zinc-500 dark:text-slate-300">
          <p className="my-4 leading-loose">
            Graduated from Bachelor of Computers at {' '}
            <a
            ...
            , I am passionate about digital, new technologies and Web Devolopement.
            Today I work in Yogyakarta, Indonesia as Backend Devoloper
            at{' '}
            <a
              ...
              target="_blank"
            >
              Transisi Teknologi Mandiri PT
            </a>
            . In addition, I actively write a personal blog. Versatile & curious in Web Development, I'm confident in several aspects like Laravel, Node Js, React Js, Next Js & Content creation.{' '}
          </p>
        </p>
        <div className="mt-8 flex flex-wrap gap-4 text-center">
          <a
            ...
            href="https://id.linkedin.com/in/muhammad-miftah-choirul-habibi-79376b131"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            ...
            href="https://github.com/chmiftah"
            rel="noreferrer"
            target="_blank"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a
            ...
            href="mailto:chmiftah7@gmail.com"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
              <path
                clipRule="evenodd"
